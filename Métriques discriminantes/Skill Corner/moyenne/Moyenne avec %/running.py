...
for i in range(3) :
     ...
     data_import = pd.read_excel(f"Métriques discriminantes/data/{dico["annee"]}/Skill Corner/data_running.xlsx", index_col = 0)
     ...
     df_final.to_excel(f"Métriques discriminantes/Tableau métriques/moyenne/{dico["annee"]}/Skill Corner/moyenne_running.xlsx")
