...
for dico in liste_dico :
     data_import = pd.read_excel(f"Data_file/Métriques Team sur une Saison Ligue 2 SB + SK/{dico["saison"]}/Skill Corner/data_running.xlsx", index_col = 0)
     ...
     data.to_excel(f"Métriques discriminantes/Tableau métriques/{dico["saison"]}/Skill Corner/running.xlsx")