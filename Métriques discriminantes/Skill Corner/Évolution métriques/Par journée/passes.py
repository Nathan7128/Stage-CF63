...
for dico in liste_dico :
    ...
    drop = ["minutes_played_per_match", "quality_check", "player_id", "player_name", "short_name", "player_birthdate", "match_name", "match_date", "team_id",
    ...
    moyenne_journée.to_excel(f"Métriques discriminantes/Tableau métriques/Evolutions métriques/Par journée/{dico["annee"]}/Skill Corner/passes_journée.xlsx")