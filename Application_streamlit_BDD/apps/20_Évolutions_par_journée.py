...
with columns[2] :
    ...
    choix_groupe_rank = st.checkbox("Sélectionner Top/Middle/Bottom", key = "widg_groupe_rank", on_change = store_session_state,
                                    args = ["groupe_rank"])
    
    load_session_state("groupe_équipe")
    choix_groupe_équipe = st.checkbox("Sélectionner équipe", key = "widg_groupe_équipe", on_change = store_session_state,
                                    args = ["groupe_équipe"])
