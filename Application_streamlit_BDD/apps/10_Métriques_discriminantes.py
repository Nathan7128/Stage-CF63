...
from fonction import couleur_diff, func_change, replace_saison1, replace_saison2
from variable import dico_type, dico_rank_SK, dico_rank_SB, dico_cat_run, dico_cat_met_pressure, dico_type_passe
...
with columns[0] :
    ...
    func_change("widg_choix_data", "choix_data")
    choix_data = st.radio("Fournisseur data", options = ["Skill Corner", "Stats Bomb"], horizontal = True,
                          key = "widg_choix_data", on_change = func_change, args = ("choix_data", "widg_choix_data"))
