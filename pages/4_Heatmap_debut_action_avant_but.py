...
with col1 :
    ...
    bin_statistic1 = pitch.bin_statistic(df_sort.x, df_sort.y, statistic='count', bins=(bins_h, bins_v), normalize=True)
...
with col2 :
    fig2, ax2 = pitch.draw()
    kde = pitch.kdeplot(df_sort.x, df_sort.y, cmap = cmr.nuclear, ax = ax2, fill = True, levels = 100, thresh = 0)
    st.pyplot(fig2)